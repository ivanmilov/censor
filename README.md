Тулза, как было задано, принимает 4 параметра, но я добавил еще один необязательный, для удобства( чтобы был вывод смещения замены и какие байты замещаются). 
